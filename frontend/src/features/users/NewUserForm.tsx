...
const NewUserForm = () => {
    ...
    return (
        <section className='form-section'>
            ...
            <p className='form-section__linkto'>Already have an account? <Link to='/login' className='form-section__button'>Log in</Link></p>
            {(validationError || isError) && 
                <div className='form-section__error'>
                    <p className='form-section__error-paragraph'><FontAwesomeIcon icon={faCircleExclamation} /> {validationError}{errMessage}</p>
                </div>
            }
            {isSuccess && 
                <div className='form-section__success'>
                    <p className='form-section__success-paragraph'><FontAwesomeIcon icon={faCircleCheck} /> User successfully created. Check your email account.</p>
                </div>
            }
        </section>
    )
