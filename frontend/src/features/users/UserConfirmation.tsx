...
export default function UserConfirmation() {
  ...
  content = (
    <div className="dashboard__confirmation">
      ...
      <p className="dashboard__confirmation-paragraph">
        Try to:
        {' '}
        <Link to="/resend-email" className="public__btn-login">Resend Email</Link>
      </p>
    </div>
  );
    ...
    content = (
      <div className="dashboard__confirmation">
        ...
        <p className="dashboard__confirmation-paragraph">
          Please:
          {' '}
          <Link to="/login" className="public__btn-login">Login</Link>
        </p>
      </div>
    );
  } else if (isError) {
